...
object Libs {
  ...
  lazy val scopt = ("com.github.scopt" %% "scopt" % "4.0.0").withCrossVersion(
    CrossVersion.for3Use2_13
  )
  lazy val `scala-csv` = ("com.github.tototoshi" %% "scala-csv" % "1.3.7")
    .withCrossVersion(CrossVersion.for3Use2_13)
  lazy val `scala-rainbow` =
    "com.github.bilal-fazlani" % "scala-rainbow" % "1.0.0"
}

object Mongo {
  val `mongo-scala-driver` =
    ("org.mongodb.scala" %% "mongo-scala-driver" % "2.9.0").withCrossVersion(
      CrossVersion.for3Use2_13
    )
}
